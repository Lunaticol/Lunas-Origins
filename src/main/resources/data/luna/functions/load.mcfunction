...
## Set scores
scoreboard players add Aequor Origin 0
...
scoreboard players add DimensionalKitsune Origin 0
scoreboard players add KingOfWrath Origin 0
scoreboard players add Noctilith Origin 0
scoreboard players add Northstar Origin 0
scoreboard players add Ronin Origin 0
scoreboard players add Scorch Origin 0
scoreboard players add Lyst Origin 0
scoreboard players add Skyweaver Origin 0
scoreboard players add Stormscale Origin 0
scoreboard players add Stormweaver Origin 0
scoreboard players add Titanmite Origin 0
scoreboard players add Lumina Origin 0
scoreboard players add Solaris Origin 0
