...
public class LunaEntities {
  ...
  public static final EntityType<CrimsonPhantom> CRIMSON_PHANTOM = Registry.register(
      Registries.ENTITY_TYPE,
      new Identifier(MOD_ID, "crimson_phantom"),
      EntityType.Builder.create(CrimsonPhantom::new, SpawnGroup.MONSTER)
          .setDimensions(1F, 0.5F)
          .build("crimson_phantom"));

  public static final EntityType<HostileAxolotl> HOSTILE_AXOLOTL = Registry.register(
      Registries.ENTITY_TYPE,
      new Identifier(MOD_ID, "hostile_axolotl"),
      EntityType.Builder.create(HostileAxolotl::new, SpawnGroup.MONSTER)
